...
public class AdvogadoAssociadoConverter implements Converter {
	
	AdvogadoAssociadoDAO advogadoAssociadoDAO;
	
	public AdvogadoAssociadoConverter() {
		this.advogadoAssociadoDAO = CDIServiceLocator.getBean(AdvogadoAssociadoDAO.class);
	}
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		if (value != null) {
			retorno = this.advogadoAssociadoDAO.buscarPeloCodigo(new Long(value));
		}
