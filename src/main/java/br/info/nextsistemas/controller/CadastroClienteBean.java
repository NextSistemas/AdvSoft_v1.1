...
import br.info.nextsistemas.service.CadastroClienteService;
...
public class CadastroClienteBean implements Serializable {
	...
	public void salvar() {
		try {
			this.cadastroClienteService.salvar(pessoa);
	...
	// metodo para Upload de imagens
		...
		public void carregaImagem() {
			...
			Long codAnexoPessoa = pessoa.getCodigo();
			Pessoa anexoPessoa = new ClienteDAO().buscarPeloCodigo(codAnexoPessoa);
